...
class _MainPlaybackScreenState extends State<MainPlaybackScreen> {
  ...
  final List<SolfeggioFrequency> _frequencies = [
    SolfeggioFrequency(hz: "174 Hz", name: "Relief & Security", description: "Alleviates pain and stress, improves concentration.", audioAssetPath: "assets/audio/174hz_30min.mp3"),
    SolfeggioFrequency(hz: "285 Hz", name: "Healing & Restoration", description: "Heals and restores tissue, supports immune system.", audioAssetPath: "assets/audio/285hz_30min.mp3"),
    SolfeggioFrequency(hz: "396 Hz", name: "Liberate Fear & Guilt", description: "Eliminates guilt, fears, and negative beliefs.", audioAssetPath: "assets/audio/396hz_30min.mp3"),
    SolfeggioFrequency(hz: "417 Hz", name: "Facilitate Change", description: "Clears negative energy, aids trauma healing.", audioAssetPath: "assets/audio/417hz_30min.mp3"),
    SolfeggioFrequency(hz: "528 Hz", name: "Love & Miracles", description: "The love frequency, transformation and miracles.", audioAssetPath: "assets/audio/528hz_30min.mp3"),
    SolfeggioFrequency(hz: "639 Hz", name: "Harmonious Relations", description: "Fosters harmonious relationships and communication.", audioAssetPath: "assets/audio/639hz_30min.mp3"),
    SolfeggioFrequency(hz: "741 Hz", name: "Intuition & Expression", description: "Stimulates creativity, self-expression, and intuition.", audioAssetPath: "assets/audio/741hz_30min.mp3"),
    SolfeggioFrequency(hz: "852 Hz", name: "Spiritual Order", description: "Replaces negative thoughts, awakens inner strength.", audioAssetPath: "assets/audio/852hz_30min.mp3"),
    SolfeggioFrequency(hz: "963 Hz", name: "Pineal Gland Activation", description: "Activates pineal gland, raises consciousness.", audioAssetPath: "assets/audio/963hz_30min.mp3"),
    SolfeggioFrequency(hz: "User Mix 1", name: "Focus Mix Alpha", description: "User provided combination for focus.", audioAssetPath: "assets/audio/user_mix_1_432hz_30min.mp3"),
  ];
